package com.fixsy.gestionsolicitudes.config;
...
@OpenAPIDefinition(
        info = @Info(
                title = "Fixsy - Request Service API",
                version = "v1",
                description = "API para gestión de solicitudes de servicio del sistema Fixsy",
        ...
        tags = {
                @Tag(name = "Requests", description = "Operaciones sobre solicitudes de servicio"),
    ...
    public io.swagger.v3.oas.models.OpenAPI customOpenAPI() {
        return new io.swagger.v3.oas.models.OpenAPI()
                ...
                .servers(java.util.List.of(
                        new io.swagger.v3.oas.models.servers.Server().url("http://localhost:8082").description("Local"),

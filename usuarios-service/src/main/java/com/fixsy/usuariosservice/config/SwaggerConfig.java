...
@OpenAPIDefinition(
        info = @Info(
                ...
                version = "v1",
                description = "API para gestión de usuarios y perfiles de mecánicos",
        ...
        tags = {
                ...
                @Tag(name = "Mechanics", description = "Operaciones sobre mecánicos"),
                @Tag(name = "Addresses", description = "Operaciones sobre direcciones")
        },
